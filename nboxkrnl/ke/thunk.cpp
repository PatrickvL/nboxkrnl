...
ULONG KernelThunkTable[379] =
{
	...
	(ULONG)FUNC(&AvSetDisplayMode),                        // 0x0003 (3)
	...
	(ULONG)FUNC(&ExReadWriteRefurbInfo),                   // 0x0019 (25)
	(ULONG)FUNC(&ExRaiseException),                        // 0x001A (26)
	(ULONG)FUNC(&ExRaiseStatus),                           // 0x001B (27)
	(ULONG)FUNC(&ExReleaseReadWriteLock),                  // 0x001C (28)
	(ULONG)FUNC(&ExSaveNonVolatileSetting),                // 0x001D (29)
	(ULONG)VARIABLE(&ExSemaphoreObjectType),               // 0x001E (30)
	...
	(ULONG)VARIABLE(&HalDiskModelNumber),                  // 0x0029 (41)
	(ULONG)VARIABLE(&HalDiskSerialNumber),                 // 0x002A (42)
	...
	(ULONG)FUNC(&IoBuildSynchronousFsdRequest),            // 0x003E (62)
	...
	(ULONG)FUNC(&IoDeleteSymbolicLink),                    // 0x0045 (69)
	...
	(ULONG)FUNC(&IoStartNextPacket),                       // 0x0051 (81)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&IoStartNextPacketByKey),                  // 0x0052 (82)
	(ULONG)FUNC(&IoStartPacket),                           // 0x0053 (83)
	(ULONG)FUNC(&IoSynchronousDeviceIoControlRequest),     // 0x0054 (84)
	(ULONG)FUNC(&IoSynchronousFsdRequest),                 // 0x0055 (85)
	...
	(ULONG)FUNC(&IoDismountVolumeByName),                  // 0x005B (91)
	...
	(ULONG)FUNC(&KeDisconnectInterrupt),                   // 0x0064 (100
	...
	(ULONG)FUNC(&KeQueryBasePriorityThread),               // 0x007C (124)
	...
	(ULONG)FUNC(&KeRemoveQueueDpc),                        // 0x0089 (137)
	(ULONG)FUNC(&KeResetEvent),                            // 0x008A (138)
	(ULONG)FUNC(&KeRestoreFloatingPointState),             // 0x008B (139)
	(ULONG)FUNC(&KeResumeThread),                          // 0x008C (140)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&KeRundownQueue),                          // 0x008D (141)
	(ULONG)FUNC(&KeSaveFloatingPointState),                // 0x008E (142)
	(ULONG)FUNC(&KeSetBasePriorityThread),                 // 0x008F (143)
	...
	(ULONG)FUNC(&KeSynchronizeExecution),                  // 0x0099 (153)
	...
	(ULONG)FUNC(&MmFreeContiguousMemory),                  // 0x00AB (171)
	...
	(ULONG)FUNC(&MmLockUnlockPhysicalPage),                // 0x00B0 (176)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&MmMapIoSpace),                            // 0x00B1 (177)
	(ULONG)FUNC(&MmPersistContiguousMemory),               // 0x00B2 (178)
	(ULONG)FUNC(&MmQueryAddressProtect),                   // 0x00B3 (179)
	(ULONG)FUNC(&MmQueryAllocationSize),                   // 0x00B4 (180)
	(ULONG)FUNC(&MmQueryStatistics),                       // 0x00B5 (181)
	(ULONG)FUNC(&MmSetAddressProtect),                     // 0x00B6 (182)
	...
	(ULONG)FUNC(&NtQuerySymbolicLinkObject),               // 0x00D7 (215)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtQueryTimer),                            // 0x00D8 (216)
	(ULONG)FUNC(&NtQueryVirtualMemory),                    // 0x00D9 (217)
	...
	(ULONG)FUNC(&NtReleaseSemaphore),                      // 0x00DE (222)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtRemoveIoCompletion),                    // 0x00DF (223)
	(ULONG)FUNC(&NtResumeThread),                          // 0x00E0 (224)
	(ULONG)FUNC(&NtSetEvent),                              // 0x00E1 (225)
	(ULONG)FUNC(&NtSetInformationFile),                    // 0x00E2 (226)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtSetIoCompletion),                       // 0x00E3 (227)
	(ULONG)FUNC(&NtSetSystemTime),                         // 0x00E4 (228)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&NtSetTimerEx),                            // 0x00E5 (229)
	(ULONG)FUNC(&NtSignalAndWaitForSingleObjectEx),        // 0x00E6 (230)
	...
	(ULONG)VARIABLE(&XboxHDKey),                           // 0x0143 (323)
	...
	(ULONG)FUNC(&XcRC4Key),                                // 0x0152 (338)
	(ULONG)FUNC(&XcRC4Crypt),                              // 0x0153 (339)
	(ULONG)FUNC(&XcHMAC),                                  // 0x0154 (340)
	...
	(ULONG)FUNC(&XcVerifyPKCS1Signature),                  // 0x0158 (344)
	(ULONG)FUNC(&XcModExp),                                // 0x0159 (345)
	(ULONG)FUNC(&XcDESKeyParity),                          // 0x015A (346)
	(ULONG)FUNC(&XcKeyTable),                              // 0x015B (347)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&XcBlockCrypt),                            // 0x015C (348)
	(ULONG)FUNC(&XcBlockCryptCBC),                         // 0x015D (349)
	(ULONG)FUNC(nullptr), //(ULONG)FUNC(&XcCryptService),                          // 0x015E (350)
	(ULONG)FUNC(&XcUpdateCrypto),                          // 0x015F (351)
	(ULONG)FUNC(&RtlRip),                                  // 0x0160 (352)
	(ULONG)VARIABLE(&XboxLANKey),                          // 0x0161 (353)
	(ULONG)FUNC(nullptr), //(ULONG)VARIABLE(&XboxAlternateSignatureKeys),          // 0x0162 (354)
	(ULONG)VARIABLE(&XePublicKeyData),                     // 0x0163 (355)
	(ULONG)VARIABLE(&HalBootSMCVideoMode),                 // 0x0164 (356)
	(ULONG)VARIABLE(&IdexChannelObject),                   // 0x0165 (357)
	(ULONG)FUNC(&HalIsResetOrShutdownPending),             // 0x0166 (358)
	(ULONG)FUNC(&IoMarkIrpMustComplete),                   // 0x0167 (359)
	(ULONG)FUNC(&HalInitiateShutdown),                     // 0x0168 (360)
	...
	(ULONG)FUNC(&HalEnableSecureTrayEject),                // 0x016D (365)
